...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv1 = GatedConv2d(8, 32, kernel_size=5, stride=1, padding=2,
                                 activation=nn.LeakyReLU(negative_slope=0.2))  # 2
        self.conv21 = GatedConv2d(32, 64, kernel_size=3, stride=2, padding=1,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 2
        ...
        self.conv3a = GatedConv2d(128, 128, kernel_size=3, stride=1, padding=1,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 4
        self.conv3b = GatedConv2d(128, 128, kernel_size=3, stride=1, padding=1,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 4
        self.conv34 = GatedConv2d(128, 256, kernel_size=3, stride=2, padding=1,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 4
        self.conv4a = GatedConv2d(256, 256, kernel_size=3, stride=1, padding=1,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 4
        self.conv4b = GatedConv2d(256, 256, kernel_size=3, stride=1, padding=1,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 4
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.conv4b = GatedConv2d(256, 256, kernel_size=3, stride=1, padding=2, dilation=2,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 4
        self.conv4a = GatedConv2d(256, 256, kernel_size=3, stride=1, padding=1,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 4
        self.conv43 = GatedConv2d(256, 128, kernel_size=3, stride=1, padding=1,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 2
        ...
        self.conv2 = GatedConv2d(64, 64, kernel_size=3, stride=1, padding=1,
                                 activation=nn.LeakyReLU(negative_slope=0.2))  # 2
        self.conv21 = GatedConv2d(64, 32, kernel_size=3, stride=1, padding=1,
                                  activation=nn.LeakyReLU(negative_slope=0.2))  # 1
...
class TCN(nn.Module):
    ...
    def forward(self, prev_frame, prev_hole, curr_frame, curr_hole, prev_hidden):
        # padding
        (prev_frame, prev_hole, curr_frame, curr_hole), pad = pad_divide_by(
            [prev_frame, prev_hole, curr_frame, curr_hole], 8, (curr_frame.size()[2], curr_frame.size()[3]))
